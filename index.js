...
app.post('/feedback',(req,res) => {
    ...
    uid=req.body.uid
    about_products=feeddata.about_products
    about_service=feeddata.about_service
    comments=feeddata.comments

    dbcon.query("insert into feedback(about_products,about_service,comments)values(?,?,?)",
    [about_products,about_service,comments],
    (err,result)=> {
        if(err){console.log(err);}
        else{
            res.send(result); 
