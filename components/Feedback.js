...
const Feedback = () => {
    const initialValues = {about_products:"",about_service:"",comments:""}
    ...
    <div>
        ...
        <div className='container mt-3'>
            <div className='row'>
                ...
                <input type='text' value={formValues.about_products} name='about_products' className='form-control' placeholder='about product' onChange={handleChange} required/> 
                </div>
